  ...
  var MentionsInput = function (input) {
    ...
    function updateValues() {
      ...
      _.each(mentionsCollection, function (mention) {
        ...
        var textHighlight = settings.templates.mentionItemHighlight({ value : utils.htmlEncode(mention.value), type : mention.type, id : mention.id, triggerChar: mention.trigger });

        mentionText = mentionText.replace(textSyntax, textHighlight);
        console.log(textSyntax, textHighlight);
      });
